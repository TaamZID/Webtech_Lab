...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form style="border:2px;  padding: 1em;" onclick="return validation()" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      <br>
        <h2>Change Password</h2>
        <br><br />
        Current Password: <input type="text" name="cpassword" id="cpassword" onkeyup="checkCurrentpassword()" onblur="checkCurrentpassword()" class="form-control">

        <span id="currentPasswordErr" class="error">* </span>
        <br><br>
        <span >New Password:</span>
        <input type="text" name="npassword" id="npassword" onkeyup="checkNewpassword()" onblur="checkNewpassword()" class="form-control">
        <span id="newPasswordErr" class="error">* </span>

        <br><br>
        <span >Retype New Password:</span>
        <input type="text" name="rnpassword" id="rnpassword" onkeyup="checkRetypepassword()" onblur="checkRetypepassword()" class="form-control">
        <span id="retypePasswordErr" class="error">* </span>
